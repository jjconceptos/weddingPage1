...
export default async function handler(req, res) {
  try {
    ...
    console.log('Received a POST request to /api/book/bookImage');
    ...
    upload.single('photo')(req, res, async function (err) {
      ...
      const bookName = req.headers['image-name'];
      const destFileName = `${bookName}.jpg`; // Assuming it's a JPEG image
