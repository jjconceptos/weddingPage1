...
const LandingPage = () => {
  ...
  const [isMobileViewport, setIsMobileViewport] = useState(false);
   ...
   const sectionsDataMobile = [
    ...
    { name: 'Hospedaje', scrollPosition: 3450 },
    { name: 'Mesa de regalos', scrollPosition: 12315 },
    { name: 'Dresscode', scrollPosition: 12350 },
        ...
        .hosting-first-margin {
          ...
          margin-bottom: 10vh; /* Adjusted margin for better separation from the next section */
              ...
              @media screen and (min-width: 1440px) and (min-height: 900px) {
                /* Add your styles for the 1440 x 900 resolution here */
              }
